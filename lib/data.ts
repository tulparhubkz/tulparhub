...
export const subAssemblies: Record<string, string[]> = {
  engine:       ['Турбокомпрессор', 'Форсунки', 'Комплект прокладок ГБЦ', 'Масляный насос', 'Гильзы цилиндров', 'Поршни и кольца', 'Водяной насос', 'Ремни и натяжители', 'Клапаны и пружины', 'Коленвал и вкладыши'],
  suspension:   ['Рессоры и листы', 'Амортизаторы', 'Сайлентблоки', 'Шкворни и втулки', 'Стабилизатор поперечной устойчивости', 'Реактивные штанги', 'Пневмоподушки', 'Балансиры'],
  electrical:   ['Генераторы', 'Стартеры', 'Аккумуляторы', 'Реле и предохранители', 'Датчики и сенсоры', 'Жгуты проводки', 'Фары и фонари', 'Выключатели и переключатели'],
  transmission: ['КПП в сборе', 'Сцепление и диск', 'Карданный вал', 'Синхронизаторы', 'Шестерни КПП', 'Подшипники КПП', 'Вилки переключения', 'Делитель / демультипликатор'],
  cabin:        ['Стёкла и уплотнители', 'Сиденья и каркасы', 'Двери и петли', 'Зеркала и кронштейны', 'Обшивка и панели', 'Отопитель кабины', 'Замки и ручки', 'Спойлеры и обтекатели'],
  brakes:       ['Тормозные колодки', 'Тормозные барабаны', 'Тормозные диски', 'Суппорты', 'Тормозные цилиндры', 'Регуляторы тормозных сил', 'Тормозные шланги', 'ABS — датчики и блоки'],
  filters:      ['Масляные фильтры', 'Топливные фильтры', 'Воздушные фильтры', 'Фильтры АКПП', 'Фильтры гидравлики', 'Фильтры-сепараторы', 'Фильтры вентиляции картера'],
  steering:     ['Рулевой механизм (ГУР)', 'Рулевые тяги и наконечники', 'Насос ГУР', 'Рулевая колонка', 'Карданчики рулевого вала', 'Цилиндр ГУР', 'Жидкость ГУР'],
  axle:         ['Главная пара (редуктор)', 'Полуоси', 'Ступицы и подшипники', 'Поворотный кулак', 'Дифференциал', 'Сателлиты и шестерни', 'Прокладки и сальники мостов'],
  fuel:         ['Топливный насос ТНВД', 'Форсунки Common Rail', 'Топливный бак', 'Топливопроводы', 'Топливный фильтр тонкой очистки', 'Регулятор давления топлива', 'Датчик уровня топлива'],
