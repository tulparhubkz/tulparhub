  ...
  const steps = [
    ...
    },
    {
      ...
      desc: isInvoice
        ...
        : isKaspi
          ? t('success.step3.descKaspi')
          : t('success.step3.descOther'),
      done: false,
    },
    {
      icon: '📦',
      ...
      <main className="success-page">
        <div className="success-wrap">
          ...
          <div className="success-hero">
            ...
            <h1>{t('success.hero.title')}</h1>
            <p>{t('success.hero.sub1')}<br/>{t('success.hero.sub2')}</p>
            <div className="order-num">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
              {num}
              <button className="copy-btn" title={t('success.copy')} onClick={() => navigator.clipboard.writeText(num)}>
          ...
          <div className="success-contacts">
            <div className="sc-text">
              <h3>{t('success.contacts.title')}</h3>
              <p>{t('success.contacts.sub')}</p>
            </div>
          ...
          <div className="success-actions">
            <Link href={`/track?num=${encodeURIComponent(num)}&phone=${encodeURIComponent(phone)}`} className="btn-outline">
